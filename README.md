...
Brave Core is a set of changes, APIs, and scripts used for customizing Chromium to make the Portal browser. Please also check https://github.com/brave/brave-browser
