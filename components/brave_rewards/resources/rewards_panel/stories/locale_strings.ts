...
export const localeStrings = {
  ...
  pendingTipText: 'For now, any tip you make will remain pending and retry automatically for 90 days. $1Learn more$2',
  pendingTipTitle: 'This creator is not signed up yet.',
  pendingTipTitleRegistered: 'You\'re connected to $1, but this creator is connected to $2. This means your tip can\'t reach this creator.',
