...
void AdBlockService::SourceProviderObserver::OnNewSourceAvailable(
...
AdBlockEngine* AdBlockService::regional_filters_service() {
  if (!regional_filters_service_) {
    regional_filters_combinator_ =
        std::make_unique<AdBlockCombinatorFiltersProvider>();
    regional_service_manager_ =
        brave_shields::AdBlockRegionalServiceManagerFactory(
            regional_filters_combinator_.get(), local_state_, locale_,
    ...
    regional_service_observer_ =
        std::make_unique<AdBlockService::SourceProviderObserver>(
            ...
            regional_filters_combinator_.get(), resource_provider_.get(),
            GetTaskRunner());
  ...
  if (!subscription_filters_service_) {
    ...
    subscription_service_observer_ =
        std::make_unique<AdBlockService::SourceProviderObserver>(
            ...
            subscription_filters_combinator_.get(), resource_provider_.get(),
            GetTaskRunner());
  }
...
AdBlockService::AdBlockService(
  ...
  subscription_service_manager_ =
      std::make_unique<brave_shields::AdBlockSubscriptionServiceManager>(
          subscription_filters_combinator_.get(), local_state_, GetTaskRunner(),
