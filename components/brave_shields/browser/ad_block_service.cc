...
AdBlockService::AdBlockService(
  ...
  regional_service_manager_ =
      brave_shields::AdBlockRegionalServiceManagerFactory(
          additional_filters_combinator_.get(), local_state_, locale_,
  ...
  subscription_service_manager_ =
      std::make_unique<brave_shields::AdBlockSubscriptionServiceManager>(
          additional_filters_combinator_.get(), local_state_, GetTaskRunner(),
  ...
  custom_filters_provider_ =
      std::make_unique<brave_shields::AdBlockCustomFiltersProvider>(
          local_state_);
  additional_filters_combinator_->CombinateProvider(
      custom_filters_provider_.get());
  ...
  additional_filters_service_observer_ =
      std::make_unique<SourceProviderObserver>(
          ...
          additional_filters_combinator_.get(), resource_provider_.get(),
          GetTaskRunner());
}
